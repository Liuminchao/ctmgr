...
<section class="layui-col-md12" style="float: none;">
    ...
    <div class="layui-card">
        <div class="layui-card-header">Ladder Register</div>
...
//            url: "index.php?r=ra/raswp/demodata",
            ...
            cols: [[
                ...
                {field: 'ladder_type', title: 'Ladder Type', edit: 'text'},
                {field: 'height', title: 'Height', edit: 'text'},
                {field: 'using_by', title: 'Using by(Company)', edit: 'text'},
        ...
        var active = {
            addRow: function(){	//添加一行
                ...
                console.log(oldData);
                var newRow = {tempId: new Date().valueOf(), ladder_type: null,height: null, using_by: null, location: null, inspected_by: null, remarks: null};
                oldData.push(newRow);
                console.log(oldData);
                tableIns.reload({
                    data : oldData
...
//                document.getElementById("jsonResult").innerHTML = JSON.stringify(table.cache[layTableId], null, 2);	//使用JSON.stringify() 格式化输出JSON字符串
                ...
                $.ajax({
                    ...
                    url: "index.php?r=device/register/addladder",
                    type: "POST",
                    dataType: "json",
                    beforeSend: function () {
