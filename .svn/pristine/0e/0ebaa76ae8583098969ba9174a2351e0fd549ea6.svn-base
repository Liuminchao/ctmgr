        ...
        <div id="responsive" class="box">
            <div class="box-body table-responsive">
                <div role="grid" class="dataTables_wrapper form-inline" id="<?php echo $this->gridId; ?>_wrapper">
                    <?php $this->renderPartial('subauthority_toolBox',array('program_id' => $program_id,'contractor_id' => $contractor_id,'contractor_name' => $contractor_name)); ?>
                    <br>
                    <div id="datagrid"><?php $this->actionSubAuthorityGrid($program_id,$contractor_id); ?></div>
                </div>
            </div>
        </div>
    </div>
