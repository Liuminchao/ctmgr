...
<?php echo $this->gridId; ?>.refresh();
    ...
    var itemAdd = function () {
        window.location = "index.php?r=chemical/chemicalmanage/new";
    }
    //批量导出
    var itemExport = function () {
        ...
        window.location = "index.php?r=chemical/chemicalmanage/chemicalexport" + url;
    }
    //修改
    var itemEdit = function (primary_id) {
        window.location = "index.php?r=chemical/chemicalmanage/edit&primary_id=" + primary_id;
    }
    //注销
    var itemLogout = function (id, name) {
       ...
       // alert("index.php?r=comp/usersubcomp/logout&confirm=1&id="+id);
        $.ajax({
            ...
            url: "index.php?r=chemical/chemicalmanage/logout",
            dataType: "json",
            type: "POST",
    ...
    var itemPhoto = function (id,primary_id) {
        window.location = "index.php?r=chemical/chemicalmanage/attachlist&chemical_id="+id+"&primary_id="+primary_id;
    }
    //统计信息
    var itemStatistics = function(id,primary_id) {
        window.location = "index.php?r=chemical/chemicalmanage/statistics&chemical_id="+id+"&primary_id="+primary_id;
    }
    //折叠详细
    ...
    var getDetail = function (obj, id) {
        ...
        $.ajax({
            data: {id: id},
            url: "index.php?r=chemical/chemicalmanage/detail",
            type: "POST",
            dataType: "json",
            beforeSend: function () {
