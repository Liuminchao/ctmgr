...
<?php echo $this->gridId; ?>.refresh();
   ...
   //下载
    ...
    var itemAdd = function() {
        window.location = "index.php?r=device/register/crane";
    }
    //编辑
    var itemEdit = function(id) {
        window.location = "index.php?r=device/register/editcrane&id="+id;
    }
    //注销
    var itemDelete = function (id) {
        ...
        $.ajax({
            ...
            url: "index.php?r=device/register/delcrane",
            dataType: "json",
            type: "POST",
    ...
    var itemExport = function () {
        ...
        window.location = "index.php?r=device/register/exportcrane" + url;
    }
</script>
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            <div class="box-body table-responsive">
                <div role="grid" class="dataTables_wrapper form-inline" id="<?php echo $this->gridId; ?>_wrapper">
                    <?php $this->renderPartial('crane_toolBox'); ?>
                    <div id="datagrid"><?php $this->actionCraneGrid(); ?></div>
                </div>
            </div>
        </div>
    </div>
