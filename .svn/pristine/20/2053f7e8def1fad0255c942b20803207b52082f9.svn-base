...
<script type="text/javascript">
    ...
    function dealImage(file)
    {
        ...
        if (!/\.(gif|jpg|jpeg|png|GIF|JPG|PNG|pdf|doc|mp4)$/.test(file.value)) {
            alert("Please upload document in either .gif, .jpeg, .jpg, .mp4, .png or .pdf format.");
            return false;
        }
//        alert("就此打住!");
//        return false;
