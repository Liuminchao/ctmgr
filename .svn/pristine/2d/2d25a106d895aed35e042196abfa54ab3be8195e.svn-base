...
<div class="row">
    <div class="col-md-3 col-md-offset-3">
        <form id="form1">
            <input type="hidden" id="program_id" name="qa[program_id]" value="<?php echo "$program_id" ?>"/>
            <input type="hidden" id="check_id" name="qa[check_id]" value="<?php echo "$check_id" ?>"/>
            <table >
                <tr id="upload"> </tr>
            </table>
        </form>
...
<script type="text/javascript">
    ...
    var back = function () {
        ...
        window.location = "index.php?r=qa/qainspection/list&program_id="+program_id;
    }
    var n = 4;
    //定时关闭弹窗
...
//        console.log(form);
    ...
    function moveFile() {
        ...
        $.ajax({
            type: "POST",
            url: "index.php?r=qa/qainspection/move",
    ...
    var raupload = function(file){
        ...
        $.each(file_list, function (name, file) {
            ...
            i++;
            document.getElementById('uploadurl').value=i;
...
//                            +"</tr>");
//                        alert(value.file1);
                            var $tr = $("<tr> <td  colspan='2'  align='right'>"+video_src_file+"</td> <td  colspan='2' align='center'>"+"<button type='button' class='btn btn-default btn-small' onclick='del_attachment(this)'>Delete</button><input type='hidden' name='qa[attachment][]' value='"+value.file1+"' ></td></tr>");
                            var $table = $("#upload");
                            $table.after($tr);
                        }
                    });
