<div class="row" style="margin-left: -20px;">
        ...
        <div class="dataTables_length">
            <form name="_query_form" id="_query_form" role="form">
                ...
                <div class="col-xs-2 padding-lr5" >
                    <input type="text" class="form-control input-sm" name="q[user_name]" placeholder="<?php echo Yii::t('comp_worker', 'Worker_name'); ?>">
                </div>
                <div class="col-xs-2 padding-lr5" >
                    <input type="text" class="form-control input-sm" name="q[worker_phone]" placeholder="<?php echo Yii::t('comp_worker', 'Worker_phone'); ?>">
                </div>
    ...
    <div class="col-xs-3">
        <div class="dataTables_filter" >
            <label>
                <button class="btn btn-primary btn-sm" onclick="itemAdd()"><?php echo Yii::t('comp_worker', 'Add Worker'); ?></button>
            </label>
        </div>
    </div>
</div>