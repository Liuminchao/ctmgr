...
//        modal.url = "index.php?r=comp/staff/upload"+url;
        window.location = "index.php?r=chemical/chemicalmanage/upload"+url;
//        modal.modal();
    }

    //编辑证书
    var itemEdit = function (id,devicce_id,primary_id) {
        window.location = "index.php?r=chemical/chemicalmanage/displayupload&id="+id+"&chemical_id="+devicce_id+"&primary_id="+primary_id;
    }
    ...
    var itemPreview = function (path,id) {
        window.location = "index.php?r=chemical/chemicalmanage/preview&certificate_photo="+path+"&id="+id;
    }
    //证件下载
    var itemDownload = function (path) {
        window.location = "index.php?r=chemical/chemicalmanage/download&certificate_photo="+path;
    }
    //证件删除
    var itemDelete = function (id,chemical_id,primary_id) {
        if (!confirm('<?php echo Yii::t('common', 'confirm_delete'); ?>')) {
            return;
        }
        $.ajax({
            data: {id: id,confirm: 1},
            url: "index.php?r=chemical/chemicalmanage/delete",
            dataType: "json",
            type: "GET",
        ...
        <div class="box">
            <div class="box-body table-responsive">
                <div role="grid" class="dataTables_wrapper form-inline" id="<?php echo $this->gridId; ?>_wrapper">
                    <?php $this->renderPartial('attach_toolBox', array('chemical_id'=>$chemical_id,'primary_id'=>$primary_id,'type'=>$type)); ?>
