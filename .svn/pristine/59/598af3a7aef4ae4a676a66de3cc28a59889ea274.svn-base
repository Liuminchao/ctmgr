    ...
    <div class="col-md-8">
        <div class="form-group">
            <label for="working_life"
                   class="col-sm-3 control-label padding-lr5"><?php echo Yii::t('train', 'train_report');?></label>
            <div class="col-sm-6 padding-lr5">
                <button class="btn btn-default" type='button' onclick="downloadtrain('<?php echo $train_id ?>','<?php echo $app_id ?>')"><?php echo Yii::t('common', 'download');?></button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    var downloadtrain =  function(id,app_id){
        window.location = "index.php?r=train/training/downloadpdf&train_id="+id+'&app_id='+app_id;
    }
