...
<div class="box-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label for="aptitude_content" class="col-sm-3 control-label padding-lr5"><?php echo $model->getAttributeLabel('aptitude_name'); ?><br>(<?php echo Yii::t('comp_staff','maxlength_remark'); ?>)</label>
                <div class="col-sm-9 padding-lr5">
                    <?php
                    echo $form->activeTextArea($model, 'aptitude_name', array('id' => 'aptitude_name', 'class' =>'form-control ','onkeyup'=>'WidthCheck(this,60);','check-type' => ''));
                    ?>
                </div>
            </div>
        </div>
