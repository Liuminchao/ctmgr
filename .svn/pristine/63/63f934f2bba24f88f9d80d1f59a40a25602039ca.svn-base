...
//        alert(start_date);
//        alert(end_date);
//         window.location = "index.php?r=license/upload/monthexport&program_id="+id+"&month="+month;
        window.location = "index.php?r=wsh/wshinspection/excel&tag=1"+"&program_id="+id+"&month="+month;
