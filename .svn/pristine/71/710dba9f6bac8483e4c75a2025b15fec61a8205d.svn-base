...
//    }
    ...
    public function actionOperatorList() {
        ...
        $this->render('operatorlist',array('id' => $id,'name' => $name,'args'=>$args));
    }
     ...
     * 保存查询链接
     */
    private function saveUrloperator() {

        $a = Yii::app()->session['list_url'];
        $a['comp/info/operatorlist'] = str_replace("r=comp/info/operatorgrid", "r=comp/info/operatorlist", $_SERVER["QUERY_STRING"]);
