...
<!--    <div >
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="form-header text-blue"><?php echo Yii::t('pay_payroll', 'storage_prompt'); ?></h3>
        </div>
    </div>
    <div class="row">
        <div class="form-group">
            ...
            <div class="input-group col-sm-6" > 
                <div class="col-sm-6 " style="padding-left: 0px"> 
                    <input id="user_phone" class="form-control " type="text" name="Storage[user_phone]" check-type="" >
                </div>
    ...
    <div class="row">
        <div class="form-group">
                ...
                <div class="input-group-addon"><i class="fa fa-calendar"></i></div> 
                    <input id="start_date" class="form-control b_date_allowance" type="text" name="Storage[start_date]" check-type="" onclick="WdatePicker({lang:'en',dateFmt:'01 MMM yyyy'})">
                    </div>
    ...
    <div class="row">
        <div class="form-group">
                ...
                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                    ...
                    <input id="end_date" class="form-control b_date_allowance" type="text" name="Storage[end_date]" check-type="" onclick="WdatePicker({lang:'en',dateFmt:'dd MMM yyyy'})">
                    </div>
                </div>
    ...
    <div class="row">
        <div class="form-group">
            <div class="col-sm-offset-4 col-sm-12">
                    <button type="button" onclick="formSubmit()"  id="sbtn" class="btn btn-primary btn-lg"><?php echo Yii::t('pay_payroll', 'button_audit'); ?></button>
...
//        alert(new_end_date);
        ...
        $.ajax({
            ...
            url: "index.php?r=payroll/salary/astorage",
            type: "POST",
            dataType: "json",
            beforeSend: function () {
                $("#loader").show();
