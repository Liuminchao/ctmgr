<style type="text/css">
    .format1{
        list-style:none; padding:0px; margin:0px; width:100%; float: left;
    }
    .format2{ width:50%; display:inline-block; float: left; padding-left: 0;text-align: left}
</style>
<?php
$t->echo_grid_header();
...
//        $str = "<input id='device_' value='1' name='device' style='position: absolute; opacity: 0;'  onclick='itemTest(\"{$row['device_id']}\")'  type='checkbox'>";
        if($row['status']=='00'){
            if ($row['check_status'] == ProgramUser::ENTRANCE_SUCCESS ) { //状态是入场审批成功
                ...
                $link .= "<ul class='format1'><li class='format2'><a style='float: left;' href='javascript:void(0)' onclick='itemChecklist(\"{$row['program_id']}\",\"{$row['primary_id']}\")'><i class=\"fa fa-fw fa-list\"></i>Routine Checklist</a></li></ul>";    //检查单
            }else if($row['check_status'] == ProgramUser::LEAVE_PENDING || $row['check_status'] == ProgramUser::LEAVE_FAIL){
                if($value == '1'){
                    $link = "<ul class='format1'><li class='format2'><a style='float: left;' href='javascript:void(0)' onclick='itemInvisible(\"{$program_id}\",\"{$row['device_id']}\")'><i class=\"fa fa-fw fa-eye\"></i>" . Yii::t('proj_project_device', 'invisible') . "</a></li><li class='format2'><a style='float: left;' href='javascript:void(0)' onclick='itemPhoto(\"{$row['device_id']}\",\"{$row['primary_id']}\")'><i class=\"fa fa-fw fa-camera\"></i>".Yii::t('device', 'Equipment_certificate')."</a></li></ul>";    //可见按钮
                    $link .= "<ul class='format1'><li class='format2'><a style='float: left; ' href='javascript:void(0)' onclick='itemDownload(\"{$program_id}\",\"{$row['device_id']}\")'><i class=\"fa fa-fw fa-cloud-download\"></i>" . Yii::t('proj_project_device', 'device_pdf') . "</a></li></ul>"; //导出设备PDF
                }else if($value == '0'){
                    $link = "<ul class='format1'><li class='format2'><a style='float: left;' href='javascript:void(0)' onclick='itemPhoto(\"{$row['device_id']}\",\"{$row['primary_id']}\")'><i class=\"fa fa-fw fa-camera\"></i>".Yii::t('device', 'Equipment_certificate')."</a></li><li class='format2'><a style='float: left; ' href='javascript:void(0)' onclick='itemDownload(\"{$program_id}\",\"{$row['device_id']}\")'><i class=\"fa fa-fw fa-cloud-download\"></i>" . Yii::t('proj_project_device', 'device_pdf') . "</a></li></ul>";    //可见按钮
                }
            } else if($row['check_status'] == ProgramUser::ENTRANCE_APPLY || $row['check_status'] == ProgramUser::ENTRANCE_PENDING){
                if($value == '1'){
                    $link = "<ul class='format1'><li class='format2'><a style='float: left; ' href='javascript:void(0)' onclick='itemDelete(\"{$program_id}\",\"{$row['device_id']}\")'><i class=\"fa fa-fw fa-times\"></i>".Yii::t('proj_project_user', 'delete')."</a></li><li class='format2'><a style='float: left;' href='javascript:void(0)' onclick='itemPhoto(\"{$row['device_id']}\",\"{$row['primary_id']}\")'><i class=\"fa fa-fw fa-camera\"></i>".Yii::t('device', 'Equipment_certificate')."</a></li></ul>";    //删除
                    $link .= "<ul class='format1'><li class='format2'><a style='float: left; ' href='javascript:void(0)' onclick='itemDownload(\"{$program_id}\",\"{$row['device_id']}\")'><i class=\"fa fa-fw fa-cloud-download\"></i>" . Yii::t('proj_project_device', 'device_pdf') . "</a></li><li class='format2'><a style='float: left; ' href='javascript:void(0)' onclick='itemInvisible(\"{$program_id}\",\"{$row['device_id']}\")'><i class=\"fa fa-fw fa-eye\"></i>" . Yii::t('proj_project_device', 'invisible') . "</a></li></ul>"; //导出设备PDF
                }else if($value == '0'){
                    $link = "<ul class='format1'><li class='format2'><a style='float: left; ' href='javascript:void(0)' onclick='itemDownload(\"{$program_id}\",\"{$row['device_id']}\")'><i class=\"fa fa-fw fa-cloud-download\"></i>" . Yii::t('proj_project_device', 'device_pdf') . "</a></li><li class='format2'><a style='float: left;' href='javascript:void(0)' onclick='itemPhoto(\"{$row['device_id']}\",\"{$row['primary_id']}\")'><i class=\"fa fa-fw fa-camera\"></i>".Yii::t('device', 'Equipment_certificate')."</a></li></ul>";    //删除
                }
            }else {
                $link = "<ul class='format1'><li class='format2'><a style='float: left;' href='javascript:void(0)' onclick='itemPhoto(\"{$row['device_id']}\",\"{$row['primary_id']}\")'><i class=\"fa fa-fw fa-camera\"></i>".Yii::t('device', 'Equipment_certificate')."</a></li></ul>";    //资质照片
            }
        }else if($row['status'] =='99'){
            $link = "<ul class='format1'><li class='format2'><a style='float: left;' href='javascript:void(0)' onclick='itemVisible(\"{$program_id}\",\"{$row['device_id']}\")'><i class=\"fa fa-fw fa-eye\"></i>".Yii::t('proj_project_device', 'visible')."</a></li></ul>";    //可见按钮
//            $link = "<li class='format2'><a href='javascript:void(0)' onclick='itemDownload(\"{$program_id}\",\"{$row['device_id']}\")'><i class=\"fa fa-fw fa-cloud-download\"></i>" . Yii::t('proj_project_device', 'device_pdf') . "</a></li></ul>"; //导出设备PDF
       ...
       $t->echo_td($row['device_id'],'center',$attr);//员工编号
...
<script type="text/javascript">
        ...
        $("table :checkbox").each(function(key,value){
            if(key != 0){
                if($(value).prop('checked')){
                    var device_id = tbodyObj.rows[key].cells[3].innerHTML;
                    tag += device_id + '|';
                }
            }
        })
    ...
    var itemCustomizeEntrance = function (program_id) {
        ...
        $("table :checkbox").each(function(key,value){
            if(key != 0){
                if($(value).prop('checked')){
                    var device_id = tbodyObj.rows[key].cells[1].innerHTML;
                    tag += device_id + '|';
                }
            }
        })
        if(tag.length == 0){
            alert('<?php echo Yii::t('proj_project_device','error_tag_is_null'); ?>');
            return false;
        }
