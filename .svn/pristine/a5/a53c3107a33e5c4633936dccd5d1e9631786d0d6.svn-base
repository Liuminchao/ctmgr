...
<header class="header">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <a href="#" onclick="itemMenu('<?php echo Yii::app()->session['program_id'] ?>','<?php echo Yii::app()->session['project_type'] ?>')" class="logo" style="white-space:nowrap;background-color: #00807d;font-family:Microsoft YaHei;">
            <!-- Add the class icon to your logo image or logo icon to add the margining -->
            <?php
...
<script type="text/javascript">
    ...
    //EPSS下载
    var itemEpss = function (id) {
        var modal=new TBModal();
        modal.title='Epss Download';
