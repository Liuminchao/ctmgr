    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-sm-6 padding-lr5">
                    <?php echo $form->activeTextField($model, 'user_name', array('id' => 'user_name', 'class' => 'form-control', 'check-type' => 'required', 'required-message' => '用户姓名不能为空')); ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-sm-6 padding-lr5">
                    <?php echo $form->activeTextField($model, 'user_phone', array('id' => 'user_phone', 'class' => 'form-control', 'check-type' => 'required', 'required-message' => '手机号码不能为空')); ?>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    //返回
    var back = function () {
        window.location = "./?<?php echo Yii::app()->session['list_url']['usersubcomp/list']; ?>";
