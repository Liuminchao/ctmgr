...
<div class="box-body">
	...
	<div class="col-sm-2"></div>
        <div class="col-sm-6 control-label" style="text-align: left"><?php echo Yii::t('common', 'confirm_white'); ?></div>
    </div>
    </hr>
    <input type="hidden" name="Staff[user_id]" value="<?php echo $id; ?>">
    <div class="row">
        <div class="col-md-6">
    <div class="form-group">
        <label for="name" class="col-sm-3 control-label padding-lr5"><?php echo Yii::t('comp_staff', 'User_name'); ?></label>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label for="white_list_type"
                       class="col-sm-3 control-label padding-lr5"><?php echo Yii::t('comp_staff','White_list_type');?></label>
                    <div style="padding-top: 6px">
                    ...
                    <?php echo $form->activeRadioButtonList($model, 'white_list_type',array('0'=>'移出白名单','1'=>'加入白名单'),array('separator'=>'&nbsp;'), array('id' => 'white_list_type','name'=>'type', 'class' => 'form-control', 'check-type' => '')); ?>
                        </div>
            </div>
        </div>
    </div>
    <div class="form-group">
        <div class="col-sm-offset-4 col-sm-10">
            <button type="button" id="sbtn" class="btn btn-primary btn-lg" onclick="ajaxAdd();"><?php echo Yii::t('common', 'button_ok'); ?></button>
...
<script type="text/javascript">
    ...
    var ajaxAdd = function () {
        ...
        $.ajax({
            url: "index.php?r=comp/staff/addwhite&" + params,
            type: "POST",
            dataType: "json",
            beforeSend: function () {
