...
<?php echo $this->gridId; ?>.refresh();
   ...
   //下载
    var itemDownload = function(id,name) {
        window.location = "index.php?r=tbm/meeting/downloadpdf&apply_id="+id+'&app_id='+name;
    }
    //添加
    var itemAdd = function() {
        window.location = "index.php?r=tbm/meeting/newplan";
    }
    //编辑
    var itemEdit = function(id) {
        window.location = "index.php?r=tbm/meeting/editplan&plan_id="+id;
    }
    //注销
    var itemDelete = function (id) {
        ...
        $.ajax({
            ...
            url: "index.php?r=tbm/meeting/delplan",
            dataType: "json",
            type: "POST",
    ...
    var itemExport = function () {
        ...
        window.location = "index.php?r=tbm/meeting/export" + url;
    }
</script>
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            <div class="box-body table-responsive">
                <div role="grid" class="dataTables_wrapper form-inline" id="<?php echo $this->gridId; ?>_wrapper">
                    ...
                    <div id="datagrid"><?php $this->actionPlanGrid(); ?></div>
                </div>
            </div>
        </div>
    </div>
