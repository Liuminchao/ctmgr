...
//    exit;
    ...
    foreach ($rows as $i => $row) {
        ...
        $preview_link = "<a href='javascript:void(0)' onclick='itemPreview(\"{$row['certificate_photo']}\",\"{$row['chemical_id']}\")'><i class=\"fa fa-fw fa-eye\"></i>" . Yii::t('electronic_contract', 'preview') . "</a>&nbsp;";
        $delete_link = "<a href='javascript:void(0)' onclick='itemDelete(\"{$row['id']}\",\"{$row['chemical_id']}\",\"{$row['primary_id']}\")'><i class=\"fa fa-fw fa-times\"></i>" . Yii::t('electronic_contract', 'delete') . "</a>";
        $download_link = "<a href='javascript:void(0)' onclick='itemDownload(\"{$row['certificate_photo']}\")'><i class=\"fa fa-fw fa-times\"></i>" . Yii::t('electronic_contract', 'download') . "</a>";
        $edit_link = "<a href='javascript:void(0)' onclick='itemEdit(\"{$row['id']}\",\"{$row['chemical_id']}\",\"{$row['primary_id']}\")'><i class=\"fa fa-fw fa-edit\"></i>".Yii::t('common', 'edit')."</a>";//编辑
...
//            $t->echo_td("<a href='javascript:void(0)' onclick='itemPreview(\"{$row['doc_path']}\",\"{$row['doc_id']}\")'>" . $row['doc_name'] . "</a>");
            $t->echo_td("<a href='index.php?r=chemical/chemicalmanage/preview&certificate_photo={$row['certificate_photo']}' target='_blank'><i class=\"fa fa-fw fa-eye\"></i>" . $row['certificate_content']. "</a>");
        }else{
...
//    alert(calssname);
        ...
        $.ajax({
            ...
            url: "index.php?r=chemical/chemicalmanage/setused",
            dataType: "json",
            type: "POST",
