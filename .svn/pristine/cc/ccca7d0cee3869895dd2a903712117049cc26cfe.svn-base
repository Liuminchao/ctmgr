 ...
 * @author LiuMinChao
 */
class QualityinspectionController extends AuthBaseController {
    ...
    public function init() {
        parent::init();
        $this->contentHeader = Yii::t('comp_quality', 'contentHeader');
//        $this->contentHeader = '';
        $this->bigMenu = Yii::t('comp_quality', 'bigMenu');
    }
    ...
    private function genDataGrid() {
        ...
        $t->url = 'index.php?r=quality/qualityinspection/grid';
        $t->updateDom = 'datagrid';
//        $t->set_header(Yii::t('comp_safety', 'check_id'), '', '');
        $t->set_header(Yii::t('comp_quality', 'sn'), '', 'center');
        $t->set_header(Yii::t('comp_quality', 'root_proname'), '', 'center');
        $t->set_header(Yii::t('comp_quality', 'title'), '', 'center');
//        $t->set_header(Yii::t('comp_quality', 'safety_type'), '', '');
        $t->set_header(Yii::t('comp_quality', 'Initiator'), '', 'center');
        $t->set_header(Yii::t('comp_quality', 'Person In Charge'), '', 'center');
//        $t->set_header(Yii::t('comp_quality', 'Person Responsible'), '', '');
//        $t->set_header(Yii::t('comp_quality', 'company'), '', '');
        $t->set_header(Yii::t('comp_quality', 'assess_name'), '', 'center');
        $t->set_header(Yii::t('comp_quality', 'item_name'), '', 'center');
        $t->set_header(Yii::t('comp_quality', 'apply_time'), '', 'center');
        $t->set_header(Yii::t('comp_quality', 'deadline_date'), '', 'center');
        $t->set_header(Yii::t('comp_quality', 'status'), '', 'center');
...
//        $args['status'] = ApplyBasic::STATUS_FINISH;
        ...
        $list = QualityCheck::queryList($page, $this->pageSize, $args);
//        var_dump($list['rows']);
    ...
    public function actionList() {
        ...
        $this->smallHeader = Yii::t('comp_quality', 'smallHeader List');
...
//        exit;
    ...
    public function actionProjectChart() {
        ...
        $this->render('statistical_project');
    }
    /**
     * 公司统计图表
     */
    ...
    public function actionCntByProject() {
        ...
        $args['module_type'] = '1';
        $r = QualityCheck::AllCntList($args);
    ...
    public function actionCntByCompany() {
        ...
        $args['contractor_id'] = Yii::app()->user->getState('contractor_id');
        $args['module_type'] = '1';
        $r = QualityCheck::CompanyCntList($args);
        print_r(json_encode($r));
    }
