...
<section class="layui-col-md12" style="float: none;">
        ...
        <div class="col-md-6"><!--  项目  -->
            <div class="form-group">
                ...
                <div class="col-sm-6 padding-lr5">
                    <select  id="program_id" name="RegisterScaffold[program_id]" style="width: 100%;" >
                        <?php
    ...
    <div class="layui-card">
        <div class="layui-card-header">Scaffold Register</div>
...
//            url: "index.php?r=ra/raswp/demodata",
            ...
            cols: [[
                ...
                {field: 'scaffold_type', title: 'Scaffold Type', edit: 'text'},
                {field: 'height', title: 'Height', edit: 'text'},
                {field: 'week_1', title: 'Week-1', edit: 'text'},
                {field: 'week_2', title: 'Week-2', edit: 'text'},
                {field: 'week_3', title: 'Week-3', edit: 'text'},
                {field: 'week_4', title: 'Week-4', edit: 'text'},
                {field: 'week_5', title: 'Week-5', edit: 'text'},
                {field: 'dismantle_date', title: 'Dismantled on(Date)', edit: 'text'},
                {field: 'location', title: 'Location', edit: 'text'},
                {field: 'inspected_by', title: 'Inspected by', edit: 'text'},
                {field: 'remarks', title: 'Remarks', edit: 'text'},
        ...
        var active = {
            addRow: function(){	//添加一行
                ...
                console.log(oldData);
                var newRow = {tempId: new Date().valueOf(), scaffold_type: null,height: null, week_1: null, week_2: null, week_3: null, week_4: null, week_5: null, dismantle_date: null, location: null, remarks: null, inspected_by:null, };
                oldData.push(newRow);
                console.log(oldData);
                tableIns.reload({
                    data : oldData
...
//                document.getElementById("jsonResult").innerHTML = JSON.stringify(table.cache[layTableId], null, 2);	//使用JSON.stringify() 格式化输出JSON字符串
                ...
                $.ajax({
                    ...
                    url: "index.php?r=device/register/addscaffold",
                    type: "POST",
                    dataType: "json",
                    beforeSend: function () {
