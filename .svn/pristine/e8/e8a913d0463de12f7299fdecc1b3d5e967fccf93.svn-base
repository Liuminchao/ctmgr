...
<div class="box-body">
    ...
    <div class="row">
        <div class="form-group">
            ...
            <div class="col-sm-6 padding-lr5">
                <?php echo $form->activeTextField($model, 'short_name', array('id' => 'short_name', 'class' => 'form-control','style'=>'text-transform:uppercase','onkeyup'=>'WidthCheck(this,20);', 'check-type' => '')); ?>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="form-group">
            <label for="link_phone" class="col-sm-3 control-label padding-lr5">Total Manday Month</label>
            <div class="col-sm-6 padding-lr5">
                <?php echo $form->activeTextField($model, 'total_manday_mon', array('id' => 'total_manday_mon', 'class' => 'form-control', 'check-type' => '', 'required-message' => '')); ?>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="form-group">
            <label for="link_phone" class="col-sm-3 control-label padding-lr5">Total Manday Ytd</label>
            <div class="col-sm-6 padding-lr5">
                <?php echo $form->activeTextField($model, 'total_manday_ytd', array('id' => 'total_manday_ytd', 'class' => 'form-control', 'check-type' => '', 'required-message' => '')); ?>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="form-group">
            <label for="link_phone" class="col-sm-3 control-label padding-lr5">Total Manpower Ytd</label>
            <div class="col-sm-6 padding-lr5">
                <?php echo $form->activeTextField($model, 'total_manpower_ytd', array('id' => 'total_manpower_ytd', 'class' => 'form-control', 'check-type' => '', 'required-message' => '')); ?>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="form-group">
            <label for="link_phone" class="col-sm-3 control-label padding-lr5">Total Manpower Month</label>
            <div class="col-sm-6 padding-lr5">
                <?php echo $form->activeTextField($model, 'total_manpower_mon', array('id' => 'total_manpower_mon', 'class' => 'form-control', 'check-type' => '', 'required-message' => '')); ?>
            </div>
        </div>
    </div>
                ...
                <div class="col-sm-3 padding-lr5">
                    <select class="form-control input-sm" name="Contractor[contractor_type]" id="contractor_type" >
                        <?php if($model->contractor_type == 'MC'){ ?>
                            ...
                            <option value="SC">SC</option>
                            <option value="consultant" >Consultant</option>
                        <?php }else if($model->contractor_type == 'MC'){ ?>
                            <option value="MC">MC</option>
                            <option value="SC" selected="selected">SC</option>
                            <option value="consultant" >Consultant</option>
                        <?php }else if($model->contractor_type == 'consultant'){ ?>
                            <option value="MC">MC</option>
                            <option value="SC">SC</option>
