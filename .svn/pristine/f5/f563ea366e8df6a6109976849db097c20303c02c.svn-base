        ...
        <div class="dataTables_length">
            <form name="_query_form" id="_query_form" role="form">
                ...
                <div class="col-xs-2 padding-lr5" style="width: 180px;">
                    <select class="form-control input-sm" name="q[contractor_type]" id="contractor_type" style="width: 100%;">
...
<!--                <div class="col-xs-2 padding-lr5" style="width: 120px;">
    ...
    <div class="col-xs-3">
        <div class="dataTables_filter" >
            <label>
                <button class="btn btn-primary btn-sm" onclick="itemAdd()"><?php echo Yii::t('comp_contractor', 'Add Contractor'); ?></button>
            </label>
        </div>
    </div>
</div>