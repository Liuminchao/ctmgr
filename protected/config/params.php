...
return array(
    ...
    'debug_log_path'    =>  './tmp',
    'upload_file_path' => "D:/Xampp/htdocs/ctmgr/attachment",//必须为本机地址
...
//    'upload_report_path' => "/opt/www-nginx/web/filebase/report",
    'upload_report_path' => "/opt/www-nginx/web/report_tmp/shell",
    ...
    'attend_params' => array(   //考勤配置
        'base_url' => 'http://'.$_SERVER["HTTP_HOST"].'/app_attendance', //attendance
