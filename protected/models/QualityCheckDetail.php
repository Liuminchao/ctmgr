 ...
 * @author LiuMinchao
 */
class QualityCheckDetail extends CActiveRecord {
    ...
    public static function detailList($check_id){
        ...
        $sql = "SELECT * FROM bac_qaqc_detail WHERE  check_id = '".$check_id."' ";//var_dump($sql);
    ...
    public static function detailAllList($args){
        ...
        $sql = "SELECT a.* FROM bac_qaqc_detail a,bac_qaqc_check b WHERE a.check_id = b.check_id AND b.contractor_id = '".$contractor_id."'
