...
class MaincompController extends AuthBaseController {
    ...
    private function genDataGrid() {
        ...
        $t->url = 'index.php?r=comp/maincomp/grid';
    ...
    private function saveUrl() {
        ...
        $a['maincomp/list'] = str_replace("r=comp/maincomp/grid", "r=comp/maincomp/list", $_SERVER["QUERY_STRING"]);
