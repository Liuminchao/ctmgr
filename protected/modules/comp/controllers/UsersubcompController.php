...
class UsersubcompController extends AuthBaseController {
    ...
    private function genDataGrid() {
        ...
        $t->url = 'index.php?r=comp/usersubcomp/grid';
    ...
    public function actionGrid() {
        ...
        $t = $this->genDataGrid();
        $this->saveUrl();
        $args['contractor_type'] = User::CONTRACTOR_TYPE_SC;
    ...
    public function actionNew() {
        ...
        $roleList = Role::roleByTypeList(User::CONTRACTOR_TYPE_SC);
        $myRoleList = array();
    ...
    private function saveUrl() {
        ...
        $a['usersubcomp/list'] = str_replace("r=comp/usersubcomp/grid", "r=comp/usersubcomp/list", $_SERVER["QUERY_STRING"]);
