...
//        $t->echo_td('<input type="checkbox"  name="checkItem" id="'.$row['user_id'].'" onclick="test(this);">');
            ...
            $t->echo_td('<a href="#" class="editable editable-click pro_flag" id="pro_flag" data-type="select" data-pk="1" data-url="index.php?r=comp/info/setauthority&program_id='.$row['program_id'].'&operator_id='.$operator_id.'" data-title="'.$title.'" >'.$flag_list[$row['flag']].'</a>','center');
            $t->end_row();
        }
    }
