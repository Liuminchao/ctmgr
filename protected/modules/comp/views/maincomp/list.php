...
<?php echo $this->gridId; ?>.refresh();
    ...
    var itemAdd = function () {
        ...
        window.location = "index.php?r=comp/maincomp/new";
    }
    //修改
    var itemEdit = function (id) {
        window.location = "index.php?r=comp/maincomp/edit&id=" + id;
    }
    //注销
    var itemLogout = function (id, name) {
        ...
        //alert("index.php?r=comp/maincomp/logout&confirm=1&id="+id);
        $.ajax({
            data: {id: id, confirm: 1},
            url: "index.php?r=comp/maincomp/logout",
            dataType: "json",
            type: "POST",
    ...
    var itemResetPwd = function (id, name) {
        ...
        $.ajax({
            data: {id: id, confirm: 1},
            url: "index.php?r=comp/maincomp/resetpwd",
            dataType: "json",
            type: "POST",
            success: function (data) {
                alert(data.msg);
    ...
    var getDetail = function (obj, id) {
        ...
        $.ajax({
            data: {id: id},
            url: "index.php?r=comp/maincomp/detail",
            type: "POST",
            dataType: "json",
            beforeSend: function () {
