...
<?php echo $this->gridId; ?>.refresh();
    ...
    var itemAdd = function() {
        ...
        modal.title = "<?php echo Yii::t('comp_mcstruct', 'Add MS'); ?>";
        modal.url = "index.php?r=comp/mcstruct/new";
        modal.modal();
    ...
    var itemEdit = function(id) {
        var modal = new TBModal();
        modal.title = "<?php echo Yii::t('comp_mcstruct', 'Edit MS'); ?>";
        modal.url = "index.php?r=comp/mcstruct/edit&id="+id;
        modal.modal();
    }
    //启用
    var itemStart = function (id, name) {
        ...
        $.ajax({
            ...
            url: "index.php?r=comp/mcstruct/start",
            dataType: "json",
            type: "POST",
    ...
    var itemStop = function (id, name) {
        ...
        $.ajax({
            data: {id: id, confirm: 1},
            url: "index.php?r=comp/mcstruct/stop",
            dataType: "json",
            type: "POST",
            success: function (data) {
