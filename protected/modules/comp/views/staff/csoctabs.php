...
<!--    <li class="active"><a href="index.php?r=comp/staff/csoctabs&user_id=--><?php //echo $user_id; ?><!--&mode=--><?php //echo $_mode_; ?><!--&title=--><?php //echo $title; ?><!--" >--><?php //echo Yii::t('comp_staff','csoc');?><!--</a></li>-->
...
<div id="myTabContent" class="tab-content">
    <div class="tab-pane fade in active" id="csoc">
        <br/>
        <?php
        //var_dump($msg);
        if($_mode_ == "insert"){
            $this->renderPartial('_csocform', array('model' => $model, 'infomodel' => $infomodel, '_mode_' => 'insert','user_id' => $user_id,'msg' => $msg));
        }else{
            $this->renderPartial('_csocform', array('model' => $model, 'infomodel' => $infomodel, '_mode_' => 'edit','user_id' => $user_id,'msg' => $msg));
        }?>
    </div>
