...
<div class="row" style="margin-top: 5px;margin-bottom: 5px;">
    <div class="col-xs-2 padding-lr5" style="padding-left: 15px">
        <select class="form-control input-sm" name="q[program]"  id="program_id" style="width: 100%">
    ...
    <div class="input-group has-error" style="float:left;">
        <div class="input-group">
            ...
            <input type="text" class="form-control input-sm tool-a-search" name="q[month]"
                   value="<?php echo $second_time ?>" id="date" onclick="WdatePicker({lang:'en',dateFmt:'yyyy'})" placeholder="<?php echo Yii::t('common', 'date_of_application'); ?>" width="100px"/>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    //ajax并发
    var all_power = function (id,date) {
        program_date(id,date);
        // ptw_cnt(id,date);
        ptw_totalcnt(id,date);
        // tbm_cnt(id,date);

        // tbm_totalcnt(id,date);

        // train_cnt(id,date);
        
        train_totalcnt(id,date);
        meet_cnt(id,date);
        meet_totalcnt(id,date);
        inspection_cnt(id);
        inspection_totalcnt(id);
        accident_cnt(id,date);
        accident_totalcnt(id,date);
    }
    //入场出场日期
    var program_date = function (id,date) {
        var user_id = $("#user_id").val();
        $.ajax({
            data:{user_id:user_id,program_id:id,date:date},
            ...
            success: function (data) {
                ...
                $.each(data, function (name, value) {
                    if(value.deal_type == 'MEMBER'){
                        var ptw_content = "<tr><td>"+value.type_name+"</td><td>"+value.deal_type+"</td><td>"+value.cnt+"<a href=\"index.php?r=license/licensepdf/list&user_id="+user_id+"&program_id="+id+"&type_id="+value.type_id+"&deal_type=-1\" target=\"view_window\">[<?php echo Yii::t('common','check'); ?>]</a></td><tr>";
                    }else{
                        var ptw_content = "<tr><td>"+value.type_name+"</td><td>"+value.deal_type+"</td><td>"+value.cnt+"<a href=\"index.php?r=license/licensepdf/list&user_id="+user_id+"&program_id="+id+"&type_id="+value.type_id+"&deal_type="+value.deal_type+"\" target=\"view_window\">[<?php echo Yii::t('common','check'); ?>]</a></td><tr>";
                    }
    ...
    //PTW总次数
    var ptw_totalcnt = function (id,date) {
        var user_id = $("#user_id").val();
        $.ajax({
            data:{user_id:user_id,program_id:id,date:date},
    ...
    var tbm_cnt = function (id,date) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data, function (name, value) {
                    if(value.deal_type == 'MEMBER'){
                        var tbm_content = "<tr><td>"+value.deal_type+"</td><td>"+value.cnt+"<a href=\"index.php?r=tbm/meeting/list&user_id="+user_id+"&program_id="+id+"&deal_type="+value.deal_type+"\" target=\"view_window\">[<?php echo Yii::t('common','check'); ?>]</a></td><td></td><tr>";
                    }else{
                        var tbm_content = "<tr><td>"+value.deal_type+"</td><td>"+value.cnt+"<a href=\"index.php?r=tbm/meeting/list&user_id="+user_id+"&program_id="+id+"&deal_type=-1\" target=\"view_window\">[<?php echo Yii::t('common','check'); ?>]</a></td><td></td><tr>";
                    }
    ...
    //TBM总次数
    var tbm_totalcnt = function (id,date) {
        var user_id = $("#user_id").val();
        $.ajax({
            data:{user_id:user_id,program_id:id,date:date},
    ...
    //TRAIN权限
    var train_cnt = function (id,date) {
        var user_id = $("#user_id").val();
        $.ajax({
            data:{user_id:user_id,program_id:id,module_type:1,date:date},
            ...
            success: function (data) {
                ...
                $.each(data, function (name, value) {
                    if(value.deal_type == 'MEMBER'){
                        var train_content = "<tr><td>"+value.type_name+"</td><td>"+value.deal_type+"</td><td>"+value.cnt+"<a href=\"index.php?r=train/training/list&user_id="+user_id+"&program_id="+id+"&deal_type="+value.deal_type+"&type_id="+value.type_id+"&module_type=1\" target=\"view_window\">[<?php echo Yii::t('common','check'); ?>]</a></td><tr>";
                    }else{
                        var train_content = "<tr><td>"+value.type_name+"</td><td>"+value.deal_type+"</td><td>"+value.cnt+"<a href=\"index.php?r=train/training/list&user_id="+user_id+"&program_id="+id+"&deal_type=-1&type_id="+value.type_id+"&module_type=1\" target=\"view_window\">[<?php echo Yii::t('common','check'); ?>]</a></td><tr>";
                    }
    ...
    //TRAIN总次数
    var train_totalcnt = function (id,date) {
        var user_id = $("#user_id").val();
        $.ajax({
            data:{user_id:user_id,program_id:id,module_type:1,date:date},
    ...
    //MEETING权限
    var meet_cnt = function (id,date) {
        var user_id = $("#user_id").val();
        $.ajax({
            data:{user_id:user_id,program_id:id,module_type:2,date:date},
            url: "index.php?r=comp/staff/trainrole",
            type: "POST",
            dataType: "json",
            beforeSend: function () {
            ...
            success: function (data) {
                ...
                $.each(data, function (name, value) {
                    if(value.deal_type == 'MEMBER'){
                        var meet_content = "<tr><td>"+value.type_name+"</td><td>"+value.deal_type+"</td><td>"+value.cnt+"<a href=\"index.php?r=train/training/list&user_id="+user_id+"&program_id="+id+"&deal_type="+value.deal_type+"&type_id="+value.type_id+"&module_type=1\" target=\"view_window\">[<?php echo Yii::t('common','check'); ?>]</a></td><tr>";
                    }else{
                        var meet_content = "<tr><td>"+value.type_name+"</td><td>"+value.deal_type+"</td><td>"+value.cnt+"<a href=\"index.php?r=train/training/list&user_id="+user_id+"&program_id="+id+"&deal_type=-1&type_id="+value.type_id+"&module_type=1\" target=\"view_window\">[<?php echo Yii::t('common','check'); ?>]</a></td><tr>";
                    }
    ...
    //MEETING总次数
    var meet_totalcnt = function (id,date) {
        var user_id = $("#user_id").val();
        $.ajax({
            data:{user_id:user_id,program_id:id,module_type:2,date:date},
            url: "index.php?r=comp/staff/traincnt",
            ...
            success: function (data) {
                ...
                $.each(data, function (name, value) {
                    ...
                    if(value.deal_type == 'Apply User'){
                        ...
                        var inspection_content = "<tr><td>"+value.type_name+"</td><td>"+value.deal_type+"</td><td>"+value.cnt+"<a href=\"index.php?r=wsh/wshinspection/list&user_id="+user_id+"&program_id="+id+"&deal_type=1&safety_level="+value.safety_level+"\" target=\"view_window\">[<?php echo Yii::t('common','check'); ?>]</a></td><tr>";
                    }else if (value.deal_type == 'Person In Charge'){
                        var inspection_content = "<tr><td>"+value.type_name+"</td><td>"+value.deal_type+"</td><td>"+value.cnt+"<a href=\"index.php?r=wsh/wshinspection/list&user_id="+user_id+"&program_id="+id+"&deal_type=2&safety_level="+value.safety_level+"\" target=\"view_window\">[<?php echo Yii::t('common','check'); ?>]</a></td><tr>";
                    }else{
                        var inspection_content = "<tr><td>"+value.type_name+"</td><td>"+value.deal_type+"</td><td>"+value.cnt+"<a href=\"index.php?r=wsh/wshinspection/list&user_id="+user_id+"&program_id="+id+"&deal_type=1&safety_level="+value.safety_level+"\" target=\"view_window\">[<?php echo Yii::t('common','check'); ?>]</a></td><tr>";
                    }
    ...
    //ACCIDENT权限
    var accident_cnt = function (id,date) {
        var user_id = $("#user_id").val();
        $.ajax({
            data:{user_id:user_id,program_id:id,date:date},
            ...
            success: function (data) {
                ...
                $.each(data, function (name, value) {
                    if(value.deal_type == 'MEMBER'){
                        var accident_content = "<tr><td>"+value.deal_type+"</td><td>"+value.cnt+"<a href=\"index.php?r=accidents/accident/list&user_id="+user_id+"&program_id="+id+"&deal_type="+value.deal_type+"\" target=\"view_window\">[<?php echo Yii::t('common','check'); ?>]</a></td><td></td><tr>";
                    }else{
    ...
    //Accident总次数
    var accident_totalcnt = function (id,date) {
        var user_id = $("#user_id").val();
        $.ajax({
            data:{user_id:user_id,program_id:id,date:date},
