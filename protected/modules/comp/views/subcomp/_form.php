...
<div class="box-body">
    ...
    <div class="row">
        <div class="form-group">
            <label for="contractor_name" class="col-sm-3 control-label padding-lr5"><?php echo Yii::t('sub_contractor', 'Contractor_name');?></label>
            <div class="col-sm-6 padding-lr5">
                <?php echo $form->activeTextField($model, 'contractor_name', array('id' => 'contractor_name', 'class' => 'form-control', 'check-type' => 'required', 'required-message' =>  Yii::t('sub_contractor','Error contractor_name is null'))); ?>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="form-group">
            ...
            <div class="col-sm-6 padding-lr5">
                <?php echo $form->activeTextField($model, 'company_adr', array('id' => 'company_adr', 'class' => 'form-control', 'check-type' => 'required', 'required-message' => Yii::t('sub_contractor','Error Address is null'))); ?>
            </div>
        </div>
    </div>
    <div class="row">
...
<script type="text/javascript">
    //返回
    var back = function () {
        window.location = "./?<?php echo Yii::app()->session['list_url']['subcomp/list']; ?>";
