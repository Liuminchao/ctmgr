...
<?php echo $this->gridId; ?>.refresh();
    ...
    var itemAdd = function () {
        ...
        window.location = "index.php?r=comp/usercomp/new";
    }
    //修改
    var itemEdit = function (id) {
        window.location = "index.php?r=comp/usercomp/edit&id=" + id;
    }
    //注销
    var itemLogout = function (id, name) {
       ...
       // alert("index.php?r=comp/usercomp/logout&confirm=1&id="+id);
        $.ajax({
            data: {id: id, confirm: 1},
            url: "index.php?r=comp/usercomp/logout",
            dataType: "json",
            type: "POST",
    ...
    var getDetail = function (obj, id) {
        ...
        $.ajax({
            data: {id: id},
            url: "index.php?r=comp/usercomp/detail",
            type: "POST",
            dataType: "json",
            beforeSend: function () {
