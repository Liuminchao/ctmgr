...
<?php echo $this->gridId; ?>.refresh();
    ...
    var itemAdd = function () {
        ...
        window.location = "index.php?r=comp/usersubcomp/new";
    }
    //修改
    var itemEdit = function (id) {
        window.location = "index.php?r=comp/usersubcomp/edit&id=" + id;
    }
    //注销
    var itemLogout = function (id, name) {
       ...
       // alert("index.php?r=comp/usersubcomp/logout&confirm=1&id="+id);
        $.ajax({
            ...
            url: "index.php?r=comp/usersubcomp/logout",
            dataType: "json",
            type: "POST",
    ...
    var getDetail = function (obj, id) {
        ...
        $.ajax({
            data: {id: id},
            url: "index.php?r=comp/usersubcomp/detail",
            type: "POST",
            dataType: "json",
            beforeSend: function () {
