...
<div class="box-body">
        ...
        <div class="col-md-6"><!--  项目  -->
            <div class="form-group">
                ...
                <div class="col-sm-6 padding-lr5">
                    <select class="form-control input-sm" id="program_id" name="RegisterScaffold[program_id]" style="width: 100%;" >
                        <?php
    ...
    <div class="row">
        <div class="col-md-6"><!--  actual_date  -->
            <div class="form-group">
                ...
                <div class="col-sm-6 padding-lr5">
                    <?php echo $form->activeTextField($model, 'scaffold_type', array('id' => 'scaffold_type', 'class' => 'form-control', 'check-type' => '')); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6"><!--  记录详情  -->
            <div class="form-group">
                ...
                <div class="col-sm-6 padding-lr5">
                    <?php echo $form->activeTextField($model, 'week_1', array('id' => 'week_1', 'class' => 'form-control', 'check-type' => '')); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6"><!--  记录详情  -->
            <div class="form-group">
                <label for="device_name" class="col-sm-3 control-label padding-lr5"><?php echo Yii::t('device', 'week_2'); ?></label>
                <div class="col-sm-6 padding-lr5">
                    <?php echo $form->activeTextField($model, 'week_2', array('id' => 'week_2', 'class' => 'form-control', 'check-type' => '')); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6"><!--  记录详情  -->
            <div class="form-group">
                <label for="device_name" class="col-sm-3 control-label padding-lr5"><?php echo Yii::t('device', 'week_3'); ?></label>
                <div class="col-sm-6 padding-lr5">
                    <?php echo $form->activeTextField($model, 'week_3', array('id' => 'week_3', 'class' => 'form-control', 'check-type' => '')); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6"><!--  记录详情  -->
            <div class="form-group">
                <label for="device_name" class="col-sm-3 control-label padding-lr5"><?php echo Yii::t('device', 'week_4'); ?></label>
                <div class="col-sm-6 padding-lr5">
                    <?php echo $form->activeTextField($model, 'week_4', array('id' => 'week_4', 'class' => 'form-control', 'check-type' => '')); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6"><!--  记录详情  -->
            <div class="form-group">
                <label for="device_name" class="col-sm-3 control-label padding-lr5"><?php echo Yii::t('device', 'week_5'); ?></label>
                <div class="col-sm-6 padding-lr5">
                    <?php echo $form->activeTextField($model, 'week_5', array('id' => 'week_5', 'class' => 'form-control', 'check-type' => '')); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6"><!--  记录详情  -->
            <div class="form-group">
                <label for="device_name" class="col-sm-3 control-label padding-lr5"><?php echo Yii::t('device', 'dismantle_date'); ?></label>
                <div class="col-sm-6 padding-lr5">
                    <?php echo $form->activeTextField($model, 'dismantle_date', array('id' => 'dismantle_date', 'class' => 'form-control', 'check-type' => '')); ?>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    //返回
    var back = function () {
        window.location = "index.php?r=device/register/scaffoldlist";
