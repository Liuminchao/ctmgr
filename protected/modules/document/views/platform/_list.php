...
//            $t->echo_td("<a href='javascript:void(0)' onclick='itemPreview(\"{$row['doc_path']}\",\"{$row['doc_id']}\")'>" . $row['doc_name'] . "</a>");
            $t->echo_td("<a href='index.php?r=document/platform/preview&doc_path={$row['doc_path']}' target='_blank'>" . $row['doc_name'].'.'.$row['doc_type'] . "</a>",'center');
        }else{
...
//        $t->echo_td('<a id="tags" class="editable editable-click" href="#" data-type="select2" data-pk="1" data-title="Enter tags" data-original-title="" title="" style="" data-url="index.php?r=document/platform/settags&doc_id='.$row['doc_id'].'">'.$label_name.'</a>');
        $t->echo_td('<a href="#" class="editable editable-click tags" data-type="select"  data-pk="1"  data-url="index.php?r=document/platform/settags&doc_id='.$row['doc_id'].'" data-title="Select Tag" >'.$tag_list[$row['label_id']].'</a>','center');
...
//    alert(calssname);
    ...
    $.ajax({
        ...
        url: "index.php?r=document/platform/setused",
        dataType: "json",
        type: "POST",
