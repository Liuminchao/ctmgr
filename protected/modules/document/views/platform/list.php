<script type="text/javascript">
    ...
    var itemUpload = function() {
        ...
        modal.url = "index.php?r=document/platform/upload";
        modal.modal();
    }
    //电子合约预览
    var itemPreview = function (path,id) {
        window.location = "index.php?r=document/platform/preview&doc_path="+path+"&doc_id="+id;
    }
    //电子合约下载
    var itemDownload = function (path) {
        window.location = "index.php?r=document/platform/download&doc_path="+path;
    }
    //电子合约删除
