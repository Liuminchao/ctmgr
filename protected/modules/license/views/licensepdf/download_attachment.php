            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <div class="col-sm-6 padding-lr5">
                        <button class="btn btn-default" type='button' onclick="downloadattachment('<?php echo $list['doc_id'] ?>')"><?php echo Yii::t('common', 'download');?></button>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    var downloadattachment =  function(id){
        window.location = "index.php?r=document/company/downloadattachment&doc_id="+id;
    }
</script>
