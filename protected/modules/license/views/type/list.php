...
<?php echo $this->gridId; ?>.refresh();
    ...
    var itemAdd = function () {
        window.location = "index.php?r=license/type/new";
    }
    //复制
    var itemCopy = function (id) {
        window.location = "index.php?r=license/type/method&id=" + id;
    }
    ...
    var itemStart = function (id, name) {
        ...
        $.ajax({
            ...
            url: "index.php?r=license/type/start",
            dataType: "json",
            type: "POST",
    ...
    var itemStop = function (id, name) {
        ...
        $.ajax({
            data: {id: id, confirm: 1},
            url: "index.php?r=license/type/stop",
            dataType: "json",
            type: "POST",
            success: function (data) {
