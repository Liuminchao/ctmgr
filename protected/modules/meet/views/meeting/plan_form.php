...
<div class="box-body">
    ...
    <div class="row">
        <div class="col-md-6" >
            <div class="form-group"><!--  项目  -->
                <label for="device_name" class="col-sm-3 control-label padding-lr5"><?php echo Yii::t('meeting','items'); ?></label>
                <div class="col-sm-6 padding-lr5">
                    <?php echo $form->activeTextField($model, 'items', array('id' => 'items', 'class' => 'form-control', 'check-type' => '')); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6"><!--  计划  -->
            <div class="form-group">
                <label for="device_name" class="col-sm-3 control-label padding-lr5"><?php echo Yii::t('meeting','schedule'); ?></label>
                <div class="col-sm-6 padding-lr5">
                    <?php echo $form->activeTextField($model, 'schedule', array('id' => 'schedule', 'class' => 'form-control', 'check-type' => '')); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6"><!--  实际  -->
            <div class="form-group">
                <label for="device_name" class="col-sm-3 control-label padding-lr5"><?php echo Yii::t('meeting','actual'); ?></label>
                <div class="col-sm-6 padding-lr5">
                    <?php echo $form->activeTextField($model, 'actual', array('id' => 'actual', 'class' => 'form-control', 'check-type' => '')); ?>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    //返回
    var back = function () {
        window.location = "index.php?r=meet/meeting/promotelist";
