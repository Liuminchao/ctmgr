...
<div class="box-body">
    ...
    <div class="row">
            ...
            <div class="col-sm-5 padding-lr5">
                <?php
                    echo $form->activeTextField($model, 'plan_start_time', array('id' => 'plan_start_time', 'class' =>'form-control b_date','readonly'=>"true", 'check-type' => 'required','required-message' => ''));
                ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-5 padding-lr5">
                <?php
                    echo $form->activeTextField($model, 'plan_end_time', array('id' => 'plan_end_time', 'class' =>'form-control b_date','readonly'=>"true",'check-type' => 'required','required-message' => ''));
                ?>
            </div>
        </div>
        </div>
...
<script type="text/javascript">
 ...
 //提交表单（添加）
    var formSubmit = function () {
        ...
        //var obj=document.getElementById('task_id');
        //alert($('#taskid option:selected').val());
        ...
        $.ajax({
            ...
            url: "index.php?r=proj/task/tnew",
            type: "POST",
            dataType: "json",
            beforeSend: function () {
    ...
    var formSubmit1 = function () {
        ...
        $.ajax({
            data:$('#form1').serialize(),
            url: "index.php?r=proj/task/tedit&task_id="+task_id+'&father_taskid='+father_taskid,
            type: "POST",
            dataType: "json",
            beforeSend: function () {
