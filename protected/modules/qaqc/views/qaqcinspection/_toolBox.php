...
<!--                </div>-->
                ...
                <div style="margin-top: -30px;margin-left: 205px;width:95px">
...
<!--                    </div>-->
<!--                </div>-->
                <div style="margin-top: -30px;margin-left: 545px;width:40px;height:30px">
                    <?php echo Yii::t('license_licensepdf', 'from'); ?>
                </div>
                <div style="margin-top: -30px;margin-left: 595px;width:110px">
                    <div class="input-group has-error">
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                ...
                <div style="margin-top: -30px;margin-left: 705px;width:40px;height:30px">
                    <?php echo Yii::t('license_licensepdf', 'to'); ?>
                </div>
                <div style="margin-top: -30px;margin-left: 755px;width:110px">
                    <div class="input-group has-error">
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                ...
                <div style="margin-top: -30px;margin-left: 875px;width:110px">
                ...
                <div style="margin-top: -30px;margin-left: 995px;width:110px">
