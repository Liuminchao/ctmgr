...
<div class="row" >
    <div class ="col-md-4 col-md-offset-9">
        ...
        <button type="button" class="btn btn-default" style="background: #44ACB7" onclick="cancel('<?php echo $list_list[0]['program_id']; ?>');">Cancel</button>
                ...
                <table id="attachment">
                    <?php if(!empty($attachment_list)){
                        foreach($attachment_list as $i => $j){
                            ?>
                            <tr><td ><img src='img/pdf_min.png'></td><td ><?php echo $j['doc_name'] ?></td><td ><button type='button' onclick='preview_attachment("<?php echo $j['doc_path']; ?>")'>Preview</button></td><td ><button type='button' onclick='del_tr(this)'>Delete</button><input type='hidden' name='rf[attachment][]' value='<?php echo $j['doc_path']; ?>' ></td></tr>
                        <?php }
                    }?>
                </table>
            </div>
