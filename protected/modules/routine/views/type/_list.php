...
if (is_array($rows)) {
    ...
    foreach ($rows as $i => $row) {
        ...
        $qr_link = "<a href='javascript:void(0)' onclick='itemQr(\"{$row['type_id']}\")'><i class=\"fa fa-fw fa-qrcode\"></i>Qr Code</a>&nbsp;";
...
//                $link = $copy_link;
                    $link =  "<table><tr><td style='white-space: nowrap' align='left'>$copy_link</td><td style='white-space: nowrap' align='left'>$detail_link</td></tr><tr><td style='white-space: nowrap' align='left'>$stop_link</td></tr></table>";
                }
            }else{
                if($row['contractor_id'] == 0){
//                $link = $copy_link;
                    $link =  "<table><tr><td style='white-space: nowrap' align='left'>$copy_link</td></tr></table>";
                }else{
//                $link = $detail_link;
