...
class SwipeController extends BaseController {
    ...
    public function init() {
        ...
        $this->smallHeader = Yii::t('dboard', 'Menu Attend failure record');
    }
    ...
    private function genDataGrid() {
        ...
        $t->url = 'index.php?r=sys/swipe/grid';
    ...
    public function actionGrid() {
        ...
        $args['programid'] = Program::getMProgramId();
//        var_dump($args['start_date']);
//        exit();
        
        
        $list = ProjectAttend::failrecord($page, $this->pageSize, $args);
