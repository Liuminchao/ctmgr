...
echo $form->activeHiddenField($model,'contractor_id');
?>
<div class="box-body">
    <div class="row">
        <div class="col-md-12">
    ...
    <div class="row">
        <div class="form-group">
            ...
            <div class="col-sm-6 padding-lr5">
                <?php echo $form->activeTextField($model, 'flow_name', array('id' => 'flow_name', 'class' => 'form-control', 'check-type' => 'required', 'required-message' => '')); ?>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="form-group">
            ...
            <div class="col-sm-6 padding-lr5">
                <div class="col-sm-6 padding-lr5 help-block"><?php $obj_list = Workflow::UseObjectText();echo $obj_list[$model->contractor_id];?></div>
            </div>
        </div>
    </div>
        <div class="row">
